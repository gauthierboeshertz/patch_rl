...
def gather_env_transitions(env,num_transitions,num_action_repeat=1,data_name="data"):
    ...
    np.savez_compressed(data_name,states=states,actions=actions,rewards=rewards,next_states=next_states,dones=dones,infos=infos)
